...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/gnuradio-iqbalance-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/gnuradio-iqbalance-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add gnuradio-iqbalance
# for installing globally
pixi global install gnuradio-iqbalance
```
...
It is possible to list all of the versions of `gnuradio-iqbalance` available on your platform:
...
```
pixi search gnuradio-iqbalance --channel conda-forge
```
